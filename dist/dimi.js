(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('json-stringify-stable')) :
	typeof define === 'function' && define.amd ? define(['json-stringify-stable'], factory) :
	(global = global || self, global.Dimi = factory(global.jsonStringifyStable));
}(this, function (jsonStringifyStable) { 'use strict';

	jsonStringifyStable = jsonStringifyStable && jsonStringifyStable.hasOwnProperty('default') ? jsonStringifyStable['default'] : jsonStringifyStable;
	...
	const arrayToObject$1 = utils.arrayToObject;
		...
		const log = logLevel => {
			return function() {
				...
				if (levels[logLevel] >= level) {
					...
					let msg = msgFormat(
						argument[0],
						serialize ? jsonStringifyStable(metadata, null, 2) : metadata,
						logLevel,
						time$1()
					);
